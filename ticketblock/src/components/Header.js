...
export default function Header() {
  ...
  async function requestAccount() {
    if (window.ethereum) {
      try {
        ...
        // Prompt user to connect if no accounts found
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-black shadow-md">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative">
              ...
              <div
                className={`absolute bg-zinc-900 rounded shadow-md z-50 w-48 py-2 mt-2 transition-all duration-200 ${dropdownBoletos ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-2 invisible'
                  }`}
              >
            ...
            <div className="relative">
              ...
              <div
                className={`absolute bg-zinc-900 rounded shadow-md z-50 w-56 py-2 mt-2 transition-all duration-200 ${dropdownOrganizadores ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-2 invisible'
                  }`}
              >
      ...
      {/* Mobile sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-2/3 bg-black transform ${menuOpen ? 'translate-x-0' : 'translate-x-full'
